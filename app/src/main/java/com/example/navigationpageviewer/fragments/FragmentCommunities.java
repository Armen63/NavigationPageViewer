...
public class FragmentCommunities extends Fragment {
    ...
    public static final String TAG = ".fragments.FragmentCommunities";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_communitie, container, false);
    }
    ...
    public static FragmentCommunities newInstance() {
        return new FragmentCommunities();
    }
}
